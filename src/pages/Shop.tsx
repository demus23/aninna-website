...
const PRODUCT_PRICE = 99; // AED — updated from 90
  ...
  return (
    <div className="min-h-screen bg-[#f8f5ef] text-[#2b211d]">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:py-20">
        ...
        {/* First-order discount reminder */}
        <div className="mx-auto mb-10 max-w-xl rounded-2xl border border-[#d4a83e] bg-[#fdf6e8] p-4 text-center">
          <p className="text-sm font-semibold text-[#7b3327]">
            🎉 New here? Use code <span className="font-bold">WELCOME10</span> at checkout for 10% off your first order.
          </p>
        </div>
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="rounded-[2rem] bg-white p-8 shadow-sm md:p-10">
            ...
            <p className="mb-4 text-2xl font-semibold text-[#2b211d]">
              AED {PRODUCT_PRICE.toFixed(2)}
            </p>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20">
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-[2rem] bg-white p-8 shadow-sm">
            <h3 className="mb-4 text-2xl font-semibold text-[#7b3327]">Why You'll Love It</h3>
            <p className="leading-8 text-[#6f6159]">Lightweight, elegant, and designed for targeted scalp care without a greasy finish.</p>
          </div>
          <div className="rounded-[2rem] bg-white p-8 shadow-sm">
            <h3 className="mb-4 text-2xl font-semibold text-[#7b3327]">Ritual-Ready Formula</h3>
            <p className="leading-8 text-[#6f6159]">Created to fit beautifully into your daily or weekly self-care routine.</p>
          </div>
          <div className="rounded-[2rem] bg-white p-8 shadow-sm">
            <h3 className="mb-4 text-2xl font-semibold text-[#7b3327]">Precision Application</h3>
            <p className="leading-8 text-[#6f6159]">The rollerball applicator helps place the serum directly where it is needed most.</p>
          </div>
        </div>
      </section>
